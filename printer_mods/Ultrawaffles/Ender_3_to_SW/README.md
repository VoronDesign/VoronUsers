...
STL files:
This mod uses some combination of both [original STL](https://github.com/VoronDesign/Voron-Switchwire/releases/tag/V1.0) and my own edited versions. The following list is parts that are unchanged. All electronic mounts except for the massive psu are from the v2.2 
1. Enclosure parts
  - feed_slot
  - light_bar_x2
