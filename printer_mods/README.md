...
| BladeScraper-Designs | [Horizontal-Spool-Holder](./BladeScraper-Designs/Horizontal-Spool-Holder) | Based on the stock holder but mounts to the horizontal extrusions. | :grey_question: | :grey_question: |:heavy_check_mark: | :x:
