...
| | [Ultimate Z chain management for CAN bus](./jbisson9/Ultimate_2.4_Z_chain_routing_CANbus) | Z chain cable routing when CAN bus is routed on the top of the printer | :x: | :x: | :heavy_check_mark: | :x: | :x: |
