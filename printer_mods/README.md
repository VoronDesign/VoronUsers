...
| GadgetAngel | [Cricut_Voron_Logos](./GadgetAngel/Cricut_Voron_Logos) |For any cutting machines or machines that relies on vector graphics and uses .svg files or vector files. These vectors or .svg files are the Voron Design Logos for the Voron 2.4, Voron SwitchWire and Voron 0.0/0.1. These .svg files use a minimal amount of anchor points to acheive the vector shapes! | :heavy_check_mark: | :x: | :heavy_check_mark: | :heavy_check_mark: | :x: |
