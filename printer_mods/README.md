...
| GAB-3D | [Filament runout sensor](gab-3d/filament-runout-sensor)| DIY filament runout sensor that is integrated in the standard filament guide | :x: | :grey_question: | :heavy_check_mark: | :grey_question: | :heavy_check_mark: |
