...
| IronAegis | [X Endstop Trigger](./iron_aegis/steathburner_chaotic_labs_cnc_tap_v2/x_endstop_trigger) | Trigger a xy joint mounted x endstop from a Chaotic Lab's CNC Tap V2 | :x: | :x: | :heavy_check_mark: | :x: |:grey_question: |
