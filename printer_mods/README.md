...
|Badnoob |[Precision AB Drive](./Badnoob/Precision_AB_Drive)|Changes the gearing for the AB drives to improve both resolution and torque, with a strengthened frame. |:grey_question:|:grey_question:|:heavy_check_mark:|
...
<<<<<<< HEAD
| | [Heatbed "Hood" Mod](./xbst_/Bed_Hinge)| A way of reaching electronics from the top by having a "car hood" style hinge for the heatbed, and rotated electronics mounts. | :x: | :x: |:heavy_check_mark: |
=======
