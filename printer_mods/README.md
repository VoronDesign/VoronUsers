...
|  | [Bigtreetech Octopus Pro V1.0 Color PIN Diagram](./GadgetAngel/Bigtreetech_Octopus_Pro_V1.0_Color_PIN_Diagram) |A color PIN Diagram in PDF file format (and a JPG file format) for the Octopus Pro V1.0 board that has been colorized so that the user can easily identify which endstops belong to which motors. Also, this PDF file labels all connectors instead of using "J" names. URL links have also been embedded in the PDF file so that the user can find additional information.  | :x: | :heavy_check_mark: | :heavy_check_mark: | :x: | :heavy_check_mark: |
|  | [Bigtreetech Octopus V1.1 Color PIN Diagram](./GadgetAngel/Bigtreetech_Octopus_V1.1_Color_PIN_Diagram) | A color PIN Diagram in PDF file format (and a JPG file format) for the Octopus V1.0 and Octopus V1.1 Board that has been colorized so that the user can easily identify which endstops belong to which motors. Also, this PDF file labels all connectors instead of using "J" names. URL links have also been embedded in the PDF file so that the user can find additional information.  | :x: | :heavy_check_mark: | :heavy_check_mark: | :x: | :heavy_check_mark: |
