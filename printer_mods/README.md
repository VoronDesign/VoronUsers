...
|LoganFraser| [PiPlate](./LoganFraser/PiPlate) | PiPlate - Raspberry Pi3,4 mounting plate and Skirt Mod for V2.4/Trident |:x:|:x:|:heavy_check_mark:|:x:|:heavy_check_mark:|
...
| Minsekt | [Rear Umbilical](https://github.com/Minsekt/VoronUsers/tree/master/printer_mods/Minsekt/2.4/Rear_Umbilical) | Rear Umbilical mounting solution | :x: | :heavey_check_mark: | :x: | :x: | :x: |
