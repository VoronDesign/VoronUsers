...
| |[Exhaust filter](./Mastah/extraction_filter/)|A mod that filter the exhaust air using carbon pelette |:grey_question: |:grey_question: |:heavy_check_mark: |:grey_question: | :grey_question: |
