...
|Batista | [Cable Drag Chain Ends half swivel](./Batista/CableChainEndLinksDownSwivelOnly) | Chain ends to avoid issues with no-name chains | :x: | :x: | :heavy_check_mark: | :x: | :x: |
