...
| MasturMynd | [Stealth Zero](./MasturMynd/V0/Stealth_Zero) | A low poly gantry with front tensioners and optional front mounted x rail | :heavy_check_mark: | :x: | :x: | :x: | :x: |
| | [V2 2-Piece Z Tensioners](./MasturMynd/V2/2-Piece_Z_Tensioners) | Stock styled Z tensioners split in two for better part orientation | :x: | :x: | :heavy_check_mark: | :x: | :x: |
