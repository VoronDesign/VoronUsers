...
| Yeri | [V0 Magnetic Front Panel](./yeri/V0_Magnetic_Front_Panel)| Mount V0 front panel with magnets, removes need for hinges | :heavy_check_mark: | :x: | :x: | :x: |
| | [V1 3Z](.yeri/v1_3z_mod)| 3Z mod for V1 | :x: | :heavy_check_mark: | :x: | :x: |
