...
| GadgetAngel | [Cricut_Voron_Logos](./GadgetAngel/Cricut_Voron_Logos) |For any cutting machine or machine that relies on vector graphics and uses .svg files or vector files. These vector or .svg files are the Voron Design Logos for the Voron 2.4, Voron SwitchWire and Voron 0.0/0.1 | :heavy_check_mark: | :x: | :heavy_check_mark: | :heavy_check_mark: | :x: |
