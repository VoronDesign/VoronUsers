...
| Tuckpolo | [V0.1 -> V0.2 Top Hat Adapter with Cam and Lights](./Tuckpolo/) | A Hat Brim Designed to fit V0.2 using V0.1 Top Hat, R-pi Camera and Adafruit Neopixel| :heavy_check_mark: | :x: | :x: | :x: | :x: |
