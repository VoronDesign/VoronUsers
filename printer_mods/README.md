...
|3dpandme|[FANnypack zero](./3dpandme/Fannypack_zero/)|Electronics cooling solution for Voron Zero|:heavy_check_mark:| :x: | :x: | :x: | :x:|
| |[Thermistor holder zero](./3dpandme/Thermistor_holder_zero/)|Extended thermistor holder for Voron Zero|:heavy_check_mark:| :x: | :x: | :x: | :x:|
