...
| |[Top cover](./andrien)   |Top Cover (multiple parts) | :heavy_check_mark: |:grey_question: |:grey_question: |
| |[Mobius Extruder mount](./andrien)  | Allowing to mount the Mobius within the case| :heavy_check_mark: |:grey_question: |:grey_question: |
| |[Hepa mount](./andrien) | Case to fit the hepa filter | :heavy_check_mark: |:grey_question: |:grey_question: |
...
| |[Side cover](./andrien)  | Insulated side cover | :heavy_check_mark: |:grey_question: |:grey_question: |
| |[Front VORON LED](./andrien)  | Mount for LED Lightning| :heavy_check_mark: |:grey_question: |:grey_question: |
| |[Front door extensions](./andrien)  | To seal the door | :heavy_check_mark: |:grey_question: |:grey_question: |
