...
|  | [Control 3D Printer with Klipper & Tasmota_plug & Fluidd](./GadgetAngel/Control_Printer_with_Klipper_Tasmota_plug_Fluidd) |Learn the steps to flash Tasmota firmware onto a Sonoff S31 plug so that you can control it through Klipper's G-code Macros to turn off the power to your 3D printer.| :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: | :heavy_check_mark: |
