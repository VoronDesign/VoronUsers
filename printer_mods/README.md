...
|Kruppes |[V0 Printed Deck with inserts](./Kruppes/V0/Deck_Panel_V0_inserts_logo) |Electronics Deck Panel using brass heat inserts. Optional Accent Voron Logo. |:x: |:x: |:x: |
