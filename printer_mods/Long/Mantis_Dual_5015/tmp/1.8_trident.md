...
| :--: | :--: |
|Koonweee’s Voron 1.8 using 2mm extended ducts| OscarGM’s Voron 1.8 with standard length ducts (found in the 2.4 folder)| 
  
<figure>
<img src="images/1.8_koonweee.png" width=50%> <img src="images/1.8_OscarGM_cut_ears.jpg" width=50% height=50%>
<figcaption align="center">Koonweee’s Voron 1.8 using 2mm extended ducts</figcaption><figcaption align="center">
