...
| Norbs12  | [Duet2+Duex RRF3 Sample Config](./duet/rrf3-sample-config) | Sample configuration for the duet2 and duex boards for the latest RRF3. | :x: | :heavy_check_mark: | :heavy_check_mark: |
