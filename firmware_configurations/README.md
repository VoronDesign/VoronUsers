...
| kage-chan  | [Installing BetterBootLoader](./klipper/kage-chan) | Install Guide for setting up BetterBootLoader on a SKR 1.3/1.4 | :grey_question: | :heavy_check_mark: | :heavy_check_mark: |
